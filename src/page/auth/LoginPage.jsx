...
export default function LoginPage() {
  ...
  const handleLogin = async () => {
    ...
    const errors = {};
    if (!formData.email.trim()) errors.email = "Please enter a email address";
    ...
    try {
      ...
      if (data?.errorCode === "OAUTH2_ACCOUNT") {
        ...
        setFieldErrors({ general: data?.error || "Login failed. Please try again." });
      }
    } finally {
      setLoading(false);
    }
      ...
      <div className="login-left">
        <div className="login-left-inner">
          <div className="login-brand">
            ...
            <span className="login-brand-name">LeaveOS</span>
          </div>
          ...
          <div className="login-hero">
            <h1 className="login-hero-title">
              Simplify your<br />
              workplace.<br />
              <span className="login-hero-accent">Make management effortless.</span>
            </h1>
          </div>
          ...
          <div className="login-form">
            ...
            <div className="login-row">
              ...
              <button
                ...
                disabled={loading}
                onClick={() => alert("Implement password reset flow")}
              >
                Forgot Password?
              </button>
            </div>
            ...
            {/* Submit */}
            <button onClick={handleLogin} disabled={loading} className="login-submit-btn">
